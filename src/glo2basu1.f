...
C     ------------------------------------------------------------------
     ...
     5          IDEALLOC_LPF,IDEALLOC_HY,INCLN,INGNC,INGNC2,INGNCn,IDPT,
...
C     ------------------------------------------------------------------
     ...
     2    IAUXSV,IOFLG,VBVL,VBNM,ISPCFM,ISPCUN,CSPCFM,IATS,NPTIMES,
     3    NPSTPS,DELTAT,TMINAT,TMAXAT,TADJAT,TCUTAT,IBUDFLAT,ICBCFLAT,
     4    IHDDFLAT,ISPCFLAT
      CHARACTER*200 LINE
C     ------------------------------------------------------------------
C
...
53          FORMAT(4X,'PRINT BUDGET')
     ...
     1              'PRINT DRAWDOWN',INOC)
         ...
         ELSE IF(LINE(ISTART:ISTOP).EQ.'CONC') THEN
            CALL SGWF2BAS7L(6,LINE,LLOC,IOFLG,NLAY,IOUT,'PRINT CONC',
     1              INOC)
            ISPCFL=1
...
57          FORMAT(4X,'SAVE BUDGET')
     ...
     1                     INOC)
            IHDDFL=1
         ELSE IF(LINE(ISTART:ISTOP).EQ.'CONC') THEN
            CALL SGWF2BAS7L(7,LINE,LLOC,IOFLG,NLAY,IOUT,'SAVE CONC',
     &                      INOC)
            ISPCFL=1
         ELSE IF(LINE(ISTART:ISTOP).EQ.'CONCENTRATION') THEN
            CALL SGWF2BAS7L(7,LINE,LLOC,IOFLG,NLAY,IOUT,'SAVE CONC',
