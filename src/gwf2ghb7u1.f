...
C2------IF CELL-BY-CELL FLOWS WILL BE SAVED AS A LIST, WRITE HEADER.
      IF(IBD.EQ.2) THEN
         ...
         CALL UBDSVHDR(IUNSTR,KSTP,KPER,IOUT,IGHBCB,ICLNCB,NODES,
     1    NCLNNDS,NCOL,NROW,NLAY,NBOUND,NGHBVL,NAUX,IBOUND,
...
C5J-----FLOW TO BNDS.
   99 CONTINUE
      IF(IBD.EQ.2)THEN 
        CALL UBDSVREC(IUNSTR,N,NODES,NCLNNDS,IGHBCB,ICLNCB,NGHBVL,
