...
C2------IF CELL-BY-CELL FLOWS WILL BE SAVED AS A LIST, WRITE HEADER.
      IF(IBD.EQ.2) THEN
         ...
         CALL UBDSVHDR(IUNSTR,KSTP,KPER,IOUT,IRIVCB,ICLNCB,NODES,
     1    NCLNNDS,NCOL,NROW,NLAY,NRIVER,NRIVVL,NAUX,IBOUND,
...
!         ELSE
!           CALL UBDSV4U(KSTP,KPER,TEXT,NAUX,RIVAUX,IRIVCB,NEQS, 
!     1          NRIVER,IOUT,DELT,PERTIM,TOTIM,IBOUND)
!         ENDIF
      END IF
C
...
C5L-----COPY FLOW TO RIVR.
   99 CONTINUE
      IF(IBD.EQ.2) THEN
        CALL UBDSVREC(IUNSTR,N,NODES,NCLNNDS,IRIVCB,ICLNCB,NRIVVL,
...
!        ELSE
!          CALL UBDSVBU(IRIVCB,NEQS,N,RATE,
...
C6------CALL UBUDSV TO SAVE THEM.
     ...
     1                          NLAY,IOUT)
      ELSE
        IF(IBD.EQ.1) CALL UBUDSVU(KSTP,KPER,TEXT,IRIVCB,BUFF(1),NEQS,
     1                          IOUT,PERTIM,TOTIM)
      ENDIF
C
