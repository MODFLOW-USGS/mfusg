...
C2------IF CELL-BY-CELL FLOWS WILL BE SAVED AS A LIST, WRITE HEADER.
      IF(IBD.EQ.2) THEN
         ...
         CALL UBDSVHDR(IUNSTR,KSTP,KPER,IOUT,IDRNCB,ICLNCB,NODES,
     1    NCLNNDS,NCOL,NROW,NLAY,NDRAIN,NDRNVL,NAUX,IBOUND,
...
C5G-----COPY FLOW TO DRAI.
   99 CONTINUE
      IF(IBD.EQ.2)THEN 
        CALL UBDSVREC(IUNSTR,N,NODES,NCLNNDS,IDRNCB,ICLNCB,NDRNVL,
